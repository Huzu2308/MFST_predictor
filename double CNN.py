...
# Input
file_path = "C:/Users/shahh/Downloads/MSFT(2000-2023).csv"  # Update with the correct path
...
# Ploting the Prices for Prediction
plt.plot(stock_data_filtered['Date'], stock_data_filtered['Close'], label='Actual Prices', color='blue')
plt.plot(future_dates, predicted_prices_rescaled, label='Predicted Prices', color='green', linestyle='-')

# Data Entering in Graph
